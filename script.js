// TODO: DOESN'T WORK IN OTHER LANGUAGES THAN ENGLISH (BECAUSE OF THE MAINSTAT THINGY...)
...
function parseSlots()
{
    ...
    if(characterClass.indexOf("Monk") != -1 || characterClass.indexOf("Demon Hunter") != -1)
    {
        mainStat = "Dexterity";
    }
    else if(characterClass.indexOf("Witch Doctor") != -1 || characterClass.indexOf("Wizard") != -1)
    {
        mainStat = "Intelligence";
    }
    else if(characterClass.indexOf("Barbarian") != -1 || characterClass.indexOf("Crusader") != -1)
    {
        mainStat = "Strength";
    }
